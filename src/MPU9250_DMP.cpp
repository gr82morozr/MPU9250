/******************************************************************************
MPU9250_DMP.cpp - MPU-9250 Digital Motion Processor Arduino Library 
...
int_return_t MPU9250_DMP::begin() {
  return this->begin(21,22);
}


int_return_t MPU9250_DMP::begin(int sda_pin, int scl_pin) {
  int_return_t result;
...
int_return_t MPU9250_DMP::enable_interrupt(unsigned char enable) {
  return set_int_enable(enable);
}

int_return_t MPU9250_DMP::set_interrupt_level(unsigned char active_low) {
  return mpu_set_int_level(active_low);
}

int_return_t MPU9250_DMP::set_int_latched(unsigned char enable) {
  return mpu_set_int_latched(enable);
}

short MPU9250_DMP::get_int_status(void) {
  short status;
...
int_return_t MPU9250_DMP::lowPowerAccel(unsigned short rate) {
  return mpu_lp_accel_mode(rate);
}

int_return_t MPU9250_DMP::set_gyro_scale(unsigned short fsr) {
  int_return_t err;
...
int_return_t MPU9250_DMP::set_accel_scale(unsigned char fsr) {
  int_return_t err;
...
unsigned short MPU9250_DMP::get_gyro_scale(void) {
  unsigned short tmp;
...
unsigned char MPU9250_DMP::get_accel_scale(void) {
  unsigned char tmp;
...
unsigned short MPU9250_DMP::get_mag_scale(void) {
  unsigned short tmp;
...
int_return_t MPU9250_DMP::setLPF(unsigned short lpf) {
...
int_return_t MPU9250_DMP::set_sample_rate(unsigned short rate) {
    return mpu_set_sample_rate(rate);
}

unsigned short MPU9250_DMP::get_sample_rate(void)
{
  unsigned short tmp;
...
int_return_t MPU9250_DMP::set_mag_sample_rate(unsigned short rate)
{
  return mpu_set_compass_sample_rate(rate);
}

unsigned short MPU9250_DMP::get_mag_sample_rate(void)
{
  unsigned short tmp;
...
float MPU9250_DMP::get_gyro_sensitivity(void) {
  float sens;
...
unsigned short MPU9250_DMP::get_accel_sensitivity(void)
{
  unsigned short sens;
...
float MPU9250_DMP::get_mag_sensitivity(void)
{
  return 0.15; // Static, 4915/32760
}

unsigned char MPU9250_DMP::get_fifo_config(void)
{
...
int_return_t MPU9250_DMP::config_fifo(unsigned char sensors) {
  return mpu_configure_fifo(sensors);
}

int_return_t MPU9250_DMP::reset_fifo(void) {
  return mpu_reset_fifo();
}

unsigned short MPU9250_DMP::get_fifo_available(void) {
...
int_return_t MPU9250_DMP::update_fifo(void) {
...
int_return_t MPU9250_DMP::set_sensors(unsigned char sensors) {
  return mpu_set_sensors(sensors);
}

bool MPU9250_DMP::is_data_ready() {
...
int_return_t MPU9250_DMP::update(unsigned char sensors) {
...
int MPU9250_DMP::update_accel(void)
{
  short data[3];
...
int MPU9250_DMP::update_gyro(void) {
  short data[3];
...
int MPU9250_DMP::update_mag(void)
{
  short data[3];
...
int_return_t MPU9250_DMP::update_temp(void) {
  return mpu_get_temperature(&temperature, &time);
}

int MPU9250_DMP::run_self_test(unsigned char debug) {
  long gyro[3], accel[3];
  return mpu_run_self_test(gyro, accel);
}

int_return_t MPU9250_DMP::begin_dmp(unsigned short features, unsigned short fifoRate) {
...
int_return_t MPU9250_DMP::load_dmp_image(void)
{
  return dmp_load_motion_driver_firmware();
}

unsigned short MPU9250_DMP::get_dmp_fifo_rate(void) {
  unsigned short rate;
...
int_return_t MPU9250_DMP::set_dmp_fifo_rate(unsigned short rate) {
  if (rate > MAX_DMP_SAMPLE_RATE) rate = MAX_DMP_SAMPLE_RATE;
  return dmp_set_fifo_rate(rate);
}

int_return_t MPU9250_DMP::update_dmp_fifo(void) {
  short gyro[3];
  short accel[3];
  long quat[4];
  unsigned long timestamp;
...
int_return_t MPU9250_DMP::enable_dmp_features(unsigned short mask) {
...
unsigned short MPU9250_DMP::get_dmp_features(void) {
  unsigned short mask;
...
int_return_t MPU9250_DMP::set_dmp_tap(
...
unsigned char MPU9250_DMP::get_dmp_tap_dir(void) {
  _tap_available = false;
  return tap_direction;
}

unsigned char MPU9250_DMP::get_dmp_tap_count(void) {
  _tap_available = false;
  return tap_count;
}

bool MPU9250_DMP::is_dmp_tap_available(void) {
  return _tap_available;
}

int_return_t MPU9250_DMP::set_dmp_orientation(const signed char * orientationMatrix) {
...
unsigned char MPU9250_DMP::get_dmp_orientation(void) {
  return mpu9250_orientation;
}

int_return_t MPU9250_DMP::enable_dmp_3quat(void) {
...
unsigned long MPU9250_DMP::get_dmp_pedometer_steps(void) {
  unsigned long steps;
...
int_return_t MPU9250_DMP::set_dmp_pedometer_steps(unsigned long steps) {
  return dmp_set_pedometer_step_count(steps);
}

unsigned long MPU9250_DMP::get_dmp_pedometer_time(void) {
...
int_return_t MPU9250_DMP::set_dmp_pedometer_time(unsigned long time) {
  return dmp_set_pedometer_walk_time(time);
}

float MPU9250_DMP::calc_accel(int axis) {
  return (float) axis / (float) _accel_sensitivity;
}

float MPU9250_DMP::calc_gyro(int axis) {
  return (float) axis / (float) _gyro_sensitivity;
}

float MPU9250_DMP::calc_mag(int axis) {
  return (float) axis / (float) _mag_sensitivity;
}

float MPU9250_DMP::calc_quat(long axis) {
  return qn_fmt_2_float(axis, 30);
}
  
float MPU9250_DMP::qn_fmt_2_float(long number, unsigned char q) {
...
void MPU9250_DMP::calc_euler_angles(bool degrees) {
...
float MPU9250_DMP::calc_mag_heading(void) {
  if (my == 0)
    heading = (mx < 0) ? PI : 0;
  else
    heading = atan2(mx, my);
