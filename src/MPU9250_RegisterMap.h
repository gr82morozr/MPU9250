/*
  ...
  Detail description - https://cdn.sparkfun.com/assets/learn_tutorials/5/5/0/MPU-9250-Register-Map.pdf


 */
#ifndef _GT_MPU9250_REGISTER_MAP_H_
#define _GT_MPU9250_REGISTER_MAP_H_
...
#endif // _GT_MPU9250_REGISTER_MAP_H_